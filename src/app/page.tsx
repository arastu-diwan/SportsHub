    ...
    <div className="body">
      ...
      <div className="inline-flex place-content-between">
        ...
        <div className="content-center">
          <span className="m-2">Explore</span>
          <span className="m-2">Sell</span>
          <span className="m-2">Favorites</span>
          <span className="m-2">My Ticket</span>
      ...
      <div className="m-1 bg-blue-400">dotted screens</div>
      <div>
        <div className="inline-flex  bg-amber-400">
          <div className="inline-flex bg-amber-100">
            <div>Location</div>
            <div> Dates</div>
          </div>
          <div className="inline-flex bg-amber-600">
            <div>All Types</div>
            <div>Sports</div>
            <div>Concerts</div>
            <div>Theater & Comedy</div>
          </div>
        </div>
      </div>

      <div>
        <h5 className="text-lg font-bold">Trending Events near Bangalore</h5>
      </div>

      <div>
        <h5 className="text-lg font-bold">Popular Categories</h5>
        <div className="card bg-amber-600 grid grid-rows-1 grid-flow-col px-5 gap-5">
      ...
      <div>
        <h5 className="text-lg font-bold">Concerts</h5>
        <div className="card bg-amber-600 grid grid-rows-1 grid-flow-col px-5 gap-5">
          <div className="relative max-w-xl mx-auto my-5">
            <img
              className="h-50 w-full object-cover rounded-md"
